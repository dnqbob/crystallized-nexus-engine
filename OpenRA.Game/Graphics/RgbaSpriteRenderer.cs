...
namespace OpenRA.Graphics
{
	public class RgbaSpriteRenderer
	{
			...
			bool isBloomSource = false, float bloomIntensity = 1f)
		{
			...
			parent.DrawSprite(s, 0, location, scale, tint, alpha, rotation, ignoreWorldTint, isBloomSource: isBloomSource,
			...
			bool isBloomSource = false, float bloomIntensity = 1f)
		{
			...
			parent.DrawSprite(s, 0, a, b, c, d, tint, alpha, isBloomSource, bloomIntensity);
		}
	}
}
